<x-app-layout>
    ...
    <div>
                        ...
                        <table class="w-full text-sm text-centre text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="py-2">Holiday Date</th>
                                    <th class="py-2">Rest Date</th>
                                        ...
                                        @if (Auth::user()->is_admin == 1)
                                            <td class="px-10 py-2">
                                                <form method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm hover:bg-red-500 hover:text-white font-bold py-2 px-4">Delete</button>
                                                </form>
                                            </td>
                                        @endif
                                    </tr>
        ...
        @if (Auth::check() && Auth::user()->is_admin == 1)
            <div class="py-1" style="max-width: 60rem; margin: 0 auto;">
                            ...
                            <div class="text-center lg:flex lg:items-center justify-between">
                                <div class="flex sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                                    <div
                                        ...
                                        <textarea name="title" id="title" {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
                                            'class' =>
                                    ...
                                    <div
                                        ...
                                        <input type="date" name="holiday_date" id="holiday_date"
                                            value="{{ old('holiday_date') }}" {{ $disabled ? 'disabled' : '' }}
                                            {!! $attributes->merge([
                                                'class' =>
                                    ...
                                    <div
                                        ...
                                        <input type="date" name="rest_date" id="rest_date"
                                            value="{{ old('rest_date') }}" {{ $disabled ? 'disabled' : '' }}
                                            {!! $attributes->merge([
                                                'class' =>
                                                    'border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm',
                                            ]) !!}>
                                    ...
                                    <div class="mt-1 leading-tight">
                                        <button type="submit"
                                            class="border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 hover:text-white font-bold py-2 px-4 mt-5 ">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
