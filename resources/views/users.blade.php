                            ...
                            <div class="text-right mb-2 mr-2">
                                <form action="{{ route('users.search') }}" method="GET">
                                    <input type="text" name="query" placeholder="Search employees..."
                                        value="{{ request('query') }}"
                                        class="py-2 px-3 rounded-md shadow-sm border-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 focus:ring-indigo-500 dark:focus:ring-indigo-600">
                                    <button type="submit"
                            ...
                            <table class="w-full text-sm text-centre text-gray-700 dark:text-gray-200">
                                ...
                                <tbody>
                                    @if (count($users) == 0)
                                        <tr>
                                            <td colspan="10"
                                                class="text-center py-8 font-semibold text-gray-800 dark:text-gray-200">
                                                No results found.
                                            </td>
                                        </tr>
                                    @else
                                            ...
                                            <tr
                                                ...
                                                <td class="px-10 py-6" style="display: inline-block;">
                                                    <div style="display: inline-flex;">
                                                        ...
                                                        <a class="ml-2"
                                                            href="{{ route('users.editUser', ['user' => $user->id]) }}"><svg
                                                                fill="currentColor" width="20px" height="20px"
                                                                viewBox="0 0 24 24" id="edit" data-name="Flat Line"
                                                                ...
                                                                <path id="primary"
                                                                    d="M21,21H3M20,4a2.09,2.09,0,0,0-2.95.12L8.17,13,7,17l4-1.17L19.88,7A2.09,2.09,0,0,0,20,4Z"
